...
const Home = () => {
  return (
    <div>
      ...
      Meta Tag: Software SaaS Portal Development for FINServ Consultants, RIAs, Vendors, and Agents
      </p>
      ...
      <div style={{ position: 'relative'}}>
        <Figure>
          ...
          <div style={{ position: 'absolute', top: '0', right: '5%', height: '100%', top:'5%'}}>
           <a name="" id="" class="btn text-light btn-warning" href="#" role="button">Sign in</a>
          </div>
          <Figure.Caption style={{ position: 'absolute', bottom: '0', color: '#fff', padding: '8px', top: '50%' }}>
            <h2>Software SaaS Development Solutions</h2>
            <hr/>
            <p>
            Software Project Development for independent FINServ<br /> consultants, virtual providers, Investment Advisors (RIAs),<br /> Insurance Agents, and Vendors..
            </p>
          </Figure.Caption>
        </Figure>
      </div>
